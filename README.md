...
| **Phase 2: Development & Experimentation**| DataOps: Create            | Implement data pipelines for automated cleaning, ingestion, and feature transformation     | Apache Airflow, Prefect, Luigi [Kafka,Spark]                                              |
|                                          |                            | Track dataset changes and store data pipelines' feature transformations                    | DVC, Pachyderm  [DVC]                                                            |
|                                          |                            | Store and manage features centrally                                                        | Feast [This capability is Optional in the workflow - We can use DVC in a low-level]                                                                     |
|                                          |                            | Explore datasets thoroughly                                                                | Facets, TensorBoard [Jupiter Notebook]                                                        |
|                                          | ModelOps: Experiment       | Conduct experiments and track models, hyperparameters, metrics, and artifacts              | MLflow, Weights & Biases, TensorBoard   [MLFlows]                                    |
|                                          |                            | Perform hyperparameter tuning                                                              | Optuna, Ray Tune    [Optuna]                                                        |
|                                          | Version Control & Collaboration | Implement code review and versioning practices; adopt a branching strategy                | Git, GitHub, GitLab [GIT]                                                       |
|                                          |                            | Integrate unit tests into MLOps model build                                                | pytest, unittest   [Pytest]                                                         |
| **Phase 3: Deployment and Monitoring**   | Deployment                 | Deploy to cloud platforms                                                                  | Kubernetes, Kubeflow, OpenShift   [Kubernetes]                                          |
|                                          |                            | Serve models in web applications                                                           | KFServing, Seldon Core, BentoML [FastAPI]                                         |
|                                          |                            | Wrap models for edge deployment                                                            | Flask, FastAPI   [FastAPI]                                                           |
|                                          | Monitoring and Maintenance | Utilize monitoring tools and logging platforms                                             | Prometheus, Grafana, ELK Stack [Full Grafana Stack]           |
|                                          |                            | Implement logging of model inputs/outputs                                                  | ELK Stack   [Full Grafana Stack]                              |
|                                          |                            | Set up performance degradation alerts                                                      | Alertmanager, Nagios [Full Grafana Stack]                                                     |
| **Phase 4: Optimization and Governance** | Model Optimization         | Profile model for bottlenecks and optimize for speed and resource usage                    | cProfile, line_profiler, TensorBoard   [TensorBoard]                                      |
|                                          |                            | Use model compression techniques to reduce size                                            | TensorFlow Lite, ONNX, PyTorch quantization [Pytorch &  TensorFlow]                               |
|                                          |                            | Implement batch mode processing for efficient inference                                    | Apache Spark, Dask, Ray [Apache Spark]                                                   |
|                                          | Security and Governance    | Secure models from unauthorized access and adversarial attacks                             | Vault by HashiCorp, Open Policy Agent (OPA) [Vault or K8s]                                |
|                                          |                            | Regularly audit models for biases                                                          | AI Fairness 360, Fairlearn   [Optional]                                               |
|                                          | Documentation              | Create thorough project documentation                                                      | MkDocs, Sphinx  [GitHub - Readme.MD]                                                            |
|                                          | Feedback Iteration         | Gather user and stakeholder feedback; iterate, refine, and redeploy                        |  We need to explore |
